...
select distinct(la."accountId"),la."loanAmount",i.amount as installment_amount,i."dueDate" as installment_duedate,at."datePosted" as transaction_date,
       i."amountPaid",i."amountDue",at.amount as transaction_amount,t.amount as transaction_amount_2,t.type as transaction_type
...
where mt."tenantId" = '12fb9ca2-9ea2-4110-a6f9-0bd86e16beea'  and a.state = 'ACTIVE' and t.type = 'REPAYMENT'-- and t.amount > 0